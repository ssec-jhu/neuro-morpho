    ...
    Neuron.skel=skel(pad+1:size(skele,1)-pad,pad+1:size(skele,2)-pad);
    Neuron.cmx= cmx-pad;
    Neuron.cmy=cmy-pad;
    ...
    if params.Fine==1
        % waitbar(0.75,f,'Starting Fine properties...');
    % n_persis=0;
    ...
    %     end
    %     % waitbar(ii/length(Br),f,'calculating Fine Properties...');
    % end
